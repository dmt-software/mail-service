...
block called **text_part**, will be rendered as text part of the message. When none of the blocks above are specified the whole template is rendered as HTML part.
